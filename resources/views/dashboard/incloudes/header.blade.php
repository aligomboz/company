...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        @include('dashboard.incloudes.menu')
        <!--begin::Wrapper-->
                                ...
                                <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                                ...
                                                <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                    <ul class="menu-subnav">
                                                        ...
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="features/icons/keenthemes-icons.html"
                                                                class="menu-link">
                                                                <i class="menu-bullet menu-bullet-dot">
                                                                    <span></span>
                                                                </i>
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a target="_blank"
                                                    href="https://preview.keenthemes.com/metronic/demo13/builder.html"
                                                    class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                                                ...
                                                                <ul class="menu-subnav">
                                                                    <li class="menu-item" aria-haspopup="true">
                                                                        <a href="crud/forms/widgets/bootstrap-datetimepicker.html"
                                                                            ...
                                                                            <span
                                                                                class="menu-text">Datetimepicker</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="menu-item" aria-haspopup="true">
                                                                    ...
                                                                    <li class="menu-item" aria-haspopup="true">
                                                                        <a href="crud/forms/widgets/bootstrap-daterangepicker.html"
                                                                            ...
                                                                            <span
                                                                                class="menu-text">Daterangepicker</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="menu-item" aria-haspopup="true">
