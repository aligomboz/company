                            ...
                            <div class="card-spacer mt-n25">
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col bg-white px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="#" class="text-warning font-weight-bold font-size-h6 mt-2">New
                                            Users</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                                    ...
                                    <div class="col">
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="font-size-sm text-muted font-weight-bold mt-1">Author Sales
                                                </div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="font-size-sm text-muted font-weight-bold mt-1">Commission
                                                </div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="font-size-sm text-muted font-weight-bold mt-1">Average Bid
                                                </div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="d-flex align-items-center mr-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="font-size-sm text-muted font-weight-bold mt-1">All Time
                                                    Sales</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-10">
                                ...
                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                    <a href="#"
                                        ...
                                        Background</a>
                                    <span class="text-muted font-weight-bold font-size-sm my-1">Strong abstract
                                        concept</span>
                                    <span class="text-muted font-weight-bold font-size-sm">Created by:
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-10">
                                ...
                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                    <a href="#"
                                        ...
                                        platter</a>
                                    <span class="text-muted font-size-sm font-weight-bold my-1">Food trends &amp;
                                        reviews</span>
                ...
                <div class="col-lg-4">
                    ...
                    <a href="#" class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Shopping Cart
                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <a href="#" class="card card-custom bg-info bg-hover-state-info card-stretch card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="font-weight-bold text-inverse-info font-size-sm">Flats, Shared Rooms, Duplex
                            </div>
                        </div>
                        <!--end::Body-->
                    </a>
